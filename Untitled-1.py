...
matrikss = [[0 for j in range(4)] for i in range(3)]

print(matrikss)

#akses index pada matriks
...
var_mat = [[5, 0],
          [1, -2]]
def_mat = [[0 for j in range(len(var_mat))] for i in range(len(var_mat))]
...
# di sederhanakan dengan numpy
import numpy as np

var_matt = np.array([[5, 0],
                    [1, -2]])
result = var_matt * 2 
print(result)
